...
var useClipboard = function useClipboard() {
  var _React$useState = _react["default"].useState("Copy"),
  ...
  var copyToClipboard = function copyToClipboard(value) {
    var ref = contentRef === null || contentRef === void 0 ? void 0 : contentRef.current;
    var code = value ? value : ref ? ref === null || ref === void 0 ? void 0 : ref.innerText : '';
