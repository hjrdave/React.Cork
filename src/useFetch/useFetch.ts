...
export default function useFetch<R = Response | undefined>(url: RequestInfo, options?: UseFetch.FetchOptions<R>) {
    ...
    const processRes = (res: Response, bodyType: UseFetch.BodyType) => {
        const resBody = {
    ...
    const parseBody = (body: any, type?: UseFetch.BodyType) => {
    ...
    //js fetch request
    const _fetch = async (params: { route?: string, body?: any, method?: string, signal?: AbortSignal | null, bodyType?: UseFetch.BodyType }) => {
    ...
    const fetchEvent = async (params: { route?: string, body?: any, method?: string, signal?: AbortSignal | null, bodyType?: UseFetch.BodyType }) => {
        if (interceptor) {
    ...
    const request = {
        get: async (route?: string, options?: { bodyType: UseFetch.BodyType }) => {
        ...
        post: async (route?: string, body?: any, options?: { bodyType: UseFetch.BodyType }) => {
